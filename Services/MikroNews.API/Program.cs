...
using MikroNews.BusinessLayer.Concrete;
using MikroNews.DataAccessLayer.Abstract;
using MikroNews.DataAccessLayer.Concrete.EfCore;
...
builder.Services.AddScoped<INewsDalRepository,EfCoreNewsDalRepository>();
